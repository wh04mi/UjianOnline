...
<!-- Header -->
<div id="header"><img src="admin/images/images_login/img_login_header.png" alt="Miniw0rm" /><blink>Silahkan Masukan No Peserta dan Password</blink></div>
...
<!-- Footer -->
<div id="footer">Login Panel | &copy; Adam_Corp<br><?php include "hitung.php"; ?></div>
