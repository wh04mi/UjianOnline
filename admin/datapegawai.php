...
<a href=\"inputpegawai.php\"><img src=\"images/images_admin/img_admin_add.png\" align=\"absmiddle\" border=\"0\" /></a>
</div>
";
...
$no		 = 1;
$sql	 = mysql_query("select * from pegawai order by kode_pegawai ASC LIMIT $posisi,$batas");
...
<a href=\"admin-home.php?page=datapegawai&act=edit&id=$r[kode_pegawai]\" class=\"action\">Edit</a>

<img src=\"images/images_admin/img_admin_delete.png\" align=\"absmiddle\" class=\"img_del\" />
<a href=\"admin-home.php?page=datapegawai&act=delete&id=$r[kode_pegawai]\" class=\"action\" onClick=\"return warning();\">Delete</a>
...
case "delete":
mysql_query("DELETE FROM pegawai WHERE kode_pegawai='$_GET[id]'");
echo "<meta http-equiv='refresh' content='0; url=admin-home.php?page=datapegawai'>"; 
break;
